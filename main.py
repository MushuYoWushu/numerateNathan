...
# utility.hidden_neuron_test(nate20)
# nate50 = NateBrain(50, .1, .7)
# utility.hidden_neuron_test(nate50)
# nate100 = NateBrain(100, .1, .7)
# utility.hidden_neuron_test(nate100)

# Quarter and Half size training set test
# quarter_nate = NateBrain(100, .1, .7)
# utility.quarter_training_set_test(quarter_nate)
# half_nate = NateBrain(100, .1, .7)
# utility.half_training_set_test(half_nate)
